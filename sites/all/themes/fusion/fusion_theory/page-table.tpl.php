    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $(".dataTables_scroll.jspScrollable").wrap('<div class="mask-table"></div>');
                ...
                if (jsp_element.data('jsp')){
                    ...
                    $(window).scroll(function() {
                        ...
                        if (pos != null && $(this).scrollTop() > pos.top) {
                            ...
                            $(".mask-table").addClass("fixed-mask-table");
                            if ($("body.admin-menu").is('*')){
                                $("body.admin-menu .dataTables_scrollHead").stop().animate({
                                    marginTop: $(window).scrollTop() - pos.top - 22
                                },0);}
                            else {
                                access.stop().animate({
